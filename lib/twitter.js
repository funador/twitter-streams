...
//////////////////////////////////////////////////////////////////////////
// Get retweeted tweets with links on tracked topics
//////////////////////////////////////////////////////////////////////////
stream
...
//////////////////////////////////////////////////////////////////////////
// Is this story being tracked? If a story is being tracked, update the
// story. Otherwise, determine whether or not to track the story.
//////////////////////////////////////////////////////////////////////////
function* initExtractGen(tweet) {
  ...
  // you can do better than this, maybe use reduce?
...
function* fullExtractGen(tweet, id, tag, url, retweeter) {
  ...
  if(img && img.includes("http") && tag) {
    ...
    // Exclude stories that are in the ignoredDomains array
...
//////////////////////////////////////////////////////////////////////////
// Delete a story after 8 hours to keep the content fresh
//////////////////////////////////////////////////////////////////////////
