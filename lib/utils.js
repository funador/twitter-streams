...
exports.expander = url => {
  return new Promise((resolve, reject) => {
    request(url, (err, res) => {
      ...
      if(res && res.statusCode !== 200) {
        console.log('--------------------------')
        console.log('Num of different status codes', ++statusCodes)
        console.log('Different statusCode', res.statusCode)
        console.log('Different statusCode', res.statusMessage)
        console.log('url', url)
        console.log('--------------------------')
      }
      if(err) {
